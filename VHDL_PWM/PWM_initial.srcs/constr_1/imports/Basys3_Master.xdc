...
# Switches
set_property -dict { PACKAGE_PIN V17    IOSTANDARD LVCMOS33 } [get_ports {PCM[0]}]					
set_property -dict { PACKAGE_PIN V16    IOSTANDARD LVCMOS33 } [get_ports {PCM[1]}]					
set_property -dict { PACKAGE_PIN W16    IOSTANDARD LVCMOS33 } [get_ports {PCM[2]}]					
set_property -dict { PACKAGE_PIN W17    IOSTANDARD LVCMOS33 } [get_ports {PCM[3]}]					
set_property -dict { PACKAGE_PIN W15    IOSTANDARD LVCMOS33 } [get_ports {PCM[4]}]					
set_property -dict { PACKAGE_PIN V15    IOSTANDARD LVCMOS33 } [get_ports {PCM[5]}]					
set_property -dict { PACKAGE_PIN W14    IOSTANDARD LVCMOS33 } [get_ports {PCM[6]}]					
set_property -dict { PACKAGE_PIN W13    IOSTANDARD LVCMOS33 } [get_ports {Scale}]					
