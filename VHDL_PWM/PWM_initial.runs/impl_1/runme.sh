...
HD_PWD='C:/Users/dotte/Documents/Projekter_DIG/PWM_initial/PWM_initial.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_v1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PWM_v1.tcl -notrace
