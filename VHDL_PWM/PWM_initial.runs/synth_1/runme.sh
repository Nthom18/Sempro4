...
HD_PWD='C:/Users/dotte/Documents/Projekter_DIG/VHDL_PWM/PWM_initial.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_v1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PWM_v1.tcl
