...
HD_PWD='C:/Users/chris/Desktop/UNI/4 Semester/PRO4/Sempro4/VHDL_SPI/SPI.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log S_TEST.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source S_TEST.tcl -notrace
