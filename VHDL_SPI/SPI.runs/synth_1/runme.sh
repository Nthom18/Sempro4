...
HD_PWD='C:/Users/chris/Desktop/UNI/4 Semester/PRO4/Sempro4/VHDL_SPI/SPI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log S_TEST.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source S_TEST.tcl
